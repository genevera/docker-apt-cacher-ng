...
```bash
docker pull quay.io/genevera/apt-cacher-ng:latest
```

Alternatively you can build the image yourself.

```bash
docker build -t quay.io/genevera/apt-cacher-ng github.com/genevera/docker-apt-cacher-ng
```
...
docker run --name apt-cacher-ng -it --rm \
  --publish 3142:3142 \
  --volume /srv/docker/apt-cacher-ng:/var/cache/apt-cacher-ng \
  quay.io/genevera/apt-cacher-ng:latest -h
```
...
docker run --name apt-cacher-ng -it --rm \
  --publish 3142:3142 \
  --volume /srv/docker/apt-cacher-ng:/var/cache/apt-cacher-ng \
  quay.io/genevera/apt-cacher-ng:latest -e
```
